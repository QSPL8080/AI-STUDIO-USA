      ...
      <div className="border-b border-slate-200/80 bg-white/90 backdrop-blur-xl shadow-xs">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-5 py-3 md:py-3.5">
          ...
          <nav
            ...
            className="hidden items-center gap-1 rounded-full border border-slate-200 bg-slate-100/70 px-2.5 py-1.5 lg:flex shadow-xs"
          >
            {nav.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="rounded-full px-3.5 py-1.5 text-xs font-semibold text-slate-600 transition-all duration-200 hover:bg-white hover:text-purple-600 hover:shadow-xs active:scale-95"
              >
                {item.label}
              </a>
            ))}
        ...
        {mobileMenuOpen && (
          <nav
            ...
            className="border-b border-slate-200 bg-white/98 px-5 py-5 shadow-2xl backdrop-blur-2xl lg:hidden animate-in fade-in slide-in-from-top-2 duration-200"
          >
    ...
    <section id="final-cta" className="scroll-mt-[72px] px-5 py-8 md:py-12 overflow-hidden relative bg-gradient-to-b from-slate-50/60 via-purple-50/20 to-slate-50/70">
      ...
      <div className="pointer-events-none absolute inset-0 select-none overflow-hidden z-0">
        ...
        >
          ...
          {/* Ambient soft glow discs */}
          <circle cx="200" cy="260" r="340" fill="url(#ctaGlowLightLeft)" className="animate-aura-pulse" />
          <circle cx="1240" cy="540" r="360" fill="url(#ctaGlowLightRight)" className="animate-aura-pulse" />
